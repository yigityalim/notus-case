...
export function BuyCard() {
  const { tokens, toggle, balance } = React.useContext(SelectedTokenContext);
  return (
    <div
      key={tokens[0].name}
    ...
    >
      <SelectToken image={tokens[0].logoURI} symbol={tokens[0].symbol} />
      <div className="flex flex-col items-end justify-between gap-3">
        <span className="text-patara-gray-600 text-xs">BUY</span>
